...
public class PrayerActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //데이터베이스를 읽어온다.
        database.getReference().child("PrayerRoom").addValueEventListener(new ValueEventListener() {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
            ...
            ((CustomViewHolder)holder).likeButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    onLikeClicked(database.getReference().child("PrayerRoom").child(uidLists.get(position)));
                }
            });
                ...
                itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View View) {
                        ...
                        String description = imageDTOs.get(position).description;
                         ...
                         String Compass = imageDTOs.get(position).Compass;
                         String Mat = imageDTOs.get(position).Mat;
                         String PrayerCostume = imageDTOs.get(position).PrayerCostume;
                         String Quran = imageDTOs.get(position).Quran;
                         String operatingTime = imageDTOs.get(position).operatingTime;

                        Intent intent = new Intent(PrayerActivity.this,PrayerDetailActivity.class);
                        ...
                        intent.putExtra("PrayerCostume", PrayerCostume);
