...
public class TourDetailActivity extends AppCompatActivity implements OnMapReadyCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //상세정보 받아와서 띄우기
        String Receive_Explanation = intent.getStringExtra("Explanation");
        String Receive_fee = intent.getStringExtra("fee");
        ...
        Explanation.setText(Receive_Explanation);
        Fee.setText(Receive_fee);
    ...
    public void onMapReady(GoogleMap googleMap) {
        LatLng Tour = new LatLng(getIntent().getDoubleExtra("lat",0.0),getIntent().getDoubleExtra("lon",0.0));
        googleMap.addMarker(new MarkerOptions().position(Tour).title("Tour"));
        googleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(Tour,15));
    }
}