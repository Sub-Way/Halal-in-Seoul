...
public class FoodDetailActivity extends AppCompatActivity implements OnMapReadyCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //상세정보 받와와서 띄우기
        String Receive_FoodKinds = intent.getStringExtra("FoodKinds");
        String Receive_PriceRange = intent.getStringExtra("PriceRange");
        String Receive_operatingTime = intent.getStringExtra("operatingTime");
        String Receive_phone = intent.getStringExtra("phone");

        Foodkinds = findViewById(R.id.Foodkinds);
        Price = findViewById(R.id.Food_Price);
        Operatingtime = findViewById(R.id.Food_Operationtime);
        Phone = findViewById(R.id.Food_Phone);

        Foodkinds.setText(Receive_FoodKinds);
        Price.setText(Receive_PriceRange);
