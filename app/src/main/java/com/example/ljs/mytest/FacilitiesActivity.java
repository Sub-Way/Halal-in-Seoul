...
public class FacilitiesActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //데이터베이스를 읽어온다.
        database.getReference().child("Facilities").addValueEventListener(new ValueEventListener() {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
            ...
            ((CustomViewHolder)holder).likeButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    onLikeClicked(database.getReference().child("Facilities").child(uidLists.get(position)));
                }
            });
                ...
                itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View View) {
                        ...
                        String description = imageDTOs.get(position).description;
                         ...
                         String Arabic = imageDTOs.get(position).Arabic;
                         String HalaFood = imageDTOs.get(position).HalalFood;
                         String PrayerRoom = imageDTOs.get(position).PrayerRoom;
                         String email = imageDTOs.get(position).email;
                         String web = imageDTOs.get(position).web;

                        Intent intent = new Intent(FacilitiesActivity.this,FacilitiesDetailActivity.class);
                        ...
                        intent.putExtra("HalalFood", HalaFood);
                        intent.putExtra("PrayerRoom", PrayerRoom);
