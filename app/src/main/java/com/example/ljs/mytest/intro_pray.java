...
public class intro_pray extends FrameLayout implements Discrollvable{
    ...
    public intro_pray(@NonNull Context context) {
        super(context);
    }

    public intro_pray(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public intro_pray(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onFinishInflate() {
        ...
        mRedView1 = findViewById(R.id.intro_pray_text);
        mRedView1TranslationY = mRedView1.getTranslationY();
        mRedView2 = findViewById(R.id.intro_pray_img);
    }
    @Override
